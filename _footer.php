      ...
      <div class="modal-body text-center">
        ...
        <div class="row">          
          <div class="col-sm-6 col-sm-offset-3 mt30">
            <a href="http://goo.gl/d2qJxK" target="_blank"><img class="img-responsive" src="/assets/img/amazon-btn.png" /></a>
            <hr class="mt30 mb30" />
            <a href="http://goo.gl/c0m3hD" target="_blank"><img class="img-responsive" src="/assets/img/bandn-btn.png" /></a>
          </div>
        </div>        
      </div>
